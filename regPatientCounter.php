												...
												<div class="row-fluid">
												     ...
												     <div class="span2 ">
													    <div class="control-group">
															<label class="control-label" for="firstName" style='color:#4b8df8' >Search by UHID jkhegfj</label>
															<div class="controls">
	...
	$.ajax({   
         type: "GET",  
        url: "<?php echo base_url('admin/MRD033/searchuhid_regP'); ?>",  
        data: "first_name="+first_name+"&uhid="+uhid+"&rfid="+rfid+"&regno="+regno+"&startdate="+startdate+"&enddate="+enddate+"&page="+page, 
