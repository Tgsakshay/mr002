...
<div class="page-content">
                            ...
                            <tbody id="opdresult">
							  ...
							  <?php  
								  ...
								  foreach($checklist as $key=>$value) {
									     ...
									     $check=$this->Common_model->getStatusOfMrd($ipppid,$uhhhid,$value['chk_id'],'chkst');
									     $quntity=$this->Common_model->getStatusOfMrd($ipppid,$uhhhid,$value['chk_id'],'quntity');
									     $mrd_chk_remark=$this->Common_model->getStatusOfMrd($ipppid,$uhhhid,$value['chk_id'],'mrd_chk_remark');
								?>
							  <tr>
                                <td data-title="">
			...
			<!-- END PAGE CONTAINER-->
				...
				<script>
	             ...
	             $.ajax({   
                            type: "POST",  
                             url: "<?php echo base_url('admin/MRD033/getValues'); ?>",  
